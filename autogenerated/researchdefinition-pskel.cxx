...
namespace fhir
{
  // ResearchDefinition_pskel
  //

  void ResearchDefinition_pskel::
  ...
  ResearchDefinition_pskel::
  ResearchDefinition_pskel (ResearchDefinition_pskel* impl, void*)
  : ::fhir::DomainResource_pskel (impl, 0),
    ResearchDefinition_impl_ (impl),
    url_parser_ (0),
    identifier_parser_ (0),
    version_parser_ (0),
    name_parser_ (0),
...
namespace fhir
{
  ...
  url ()
  {
    if (this->ResearchDefinition_impl_)
      this->ResearchDefinition_impl_->url ();
  }
  ...
  {
    if (this->ResearchDefinition_impl_)
      this->ResearchDefinition_impl_->identifier ();
  }
  ...
  {
    if (this->ResearchDefinition_impl_)
      this->ResearchDefinition_impl_->version ();
  }
  ...
  {
    if (this->ResearchDefinition_impl_)
      this->ResearchDefinition_impl_->name ();
  }
  ...
  {
    if (this->ResearchDefinition_impl_)
      this->ResearchDefinition_impl_->title ();
  }
  ...
  {
    if (this->ResearchDefinition_impl_)
      this->ResearchDefinition_impl_->shortTitle ();
  }
  ...
  {
    if (this->ResearchDefinition_impl_)
      this->ResearchDefinition_impl_->subtitle ();
  }
  ...
  {
    if (this->ResearchDefinition_impl_)
      this->ResearchDefinition_impl_->status ();
  }
  ...
  {
    if (this->ResearchDefinition_impl_)
      this->ResearchDefinition_impl_->experimental ();
  }
  ...
  {
    if (this->ResearchDefinition_impl_)
      this->ResearchDefinition_impl_->subjectCodeableConcept ();
  }
  ...
  {
    if (this->ResearchDefinition_impl_)
      this->ResearchDefinition_impl_->subjectReference ();
  }
  ...
  {
    if (this->ResearchDefinition_impl_)
      this->ResearchDefinition_impl_->date ();
  }
  ...
  {
    if (this->ResearchDefinition_impl_)
      this->ResearchDefinition_impl_->publisher ();
  }
  ...
  {
    if (this->ResearchDefinition_impl_)
      this->ResearchDefinition_impl_->contact ();
  }
  ...
  {
    if (this->ResearchDefinition_impl_)
      this->ResearchDefinition_impl_->description ();
  }
  ...
  {
    if (this->ResearchDefinition_impl_)
      this->ResearchDefinition_impl_->comment ();
  }
  ...
  {
    if (this->ResearchDefinition_impl_)
      this->ResearchDefinition_impl_->useContext ();
  }
  ...
  {
    if (this->ResearchDefinition_impl_)
      this->ResearchDefinition_impl_->jurisdiction ();
  }
  ...
  {
    if (this->ResearchDefinition_impl_)
      this->ResearchDefinition_impl_->purpose ();
  }
  ...
  {
    if (this->ResearchDefinition_impl_)
      this->ResearchDefinition_impl_->usage ();
  }
  ...
  {
    if (this->ResearchDefinition_impl_)
      this->ResearchDefinition_impl_->copyright ();
  }
  ...
  {
    if (this->ResearchDefinition_impl_)
      this->ResearchDefinition_impl_->approvalDate ();
  }
  ...
  {
    if (this->ResearchDefinition_impl_)
      this->ResearchDefinition_impl_->lastReviewDate ();
  }
  ...
  {
    if (this->ResearchDefinition_impl_)
      this->ResearchDefinition_impl_->effectivePeriod ();
  }
  ...
  {
    if (this->ResearchDefinition_impl_)
      this->ResearchDefinition_impl_->topic ();
  }
  ...
  {
    if (this->ResearchDefinition_impl_)
      this->ResearchDefinition_impl_->author ();
  }
  ...
  {
    if (this->ResearchDefinition_impl_)
      this->ResearchDefinition_impl_->editor ();
  }
  ...
  {
    if (this->ResearchDefinition_impl_)
      this->ResearchDefinition_impl_->reviewer ();
  }
  ...
  {
    if (this->ResearchDefinition_impl_)
      this->ResearchDefinition_impl_->endorser ();
  }
  ...
  {
    if (this->ResearchDefinition_impl_)
      this->ResearchDefinition_impl_->relatedArtifact ();
  }
  ...
  {
    if (this->ResearchDefinition_impl_)
      this->ResearchDefinition_impl_->library ();
  }
  ...
  {
    if (this->ResearchDefinition_impl_)
      this->ResearchDefinition_impl_->population ();
  }
  ...
  {
    if (this->ResearchDefinition_impl_)
      this->ResearchDefinition_impl_->exposure ();
  }
  ...
  {
    if (this->ResearchDefinition_impl_)
      this->ResearchDefinition_impl_->exposureAlternative ();
  }
  ...
  {
    if (this->ResearchDefinition_impl_)
      this->ResearchDefinition_impl_->outcome ();
  }
  ...
  {
    if (this->ResearchDefinition_impl_)
      this->ResearchDefinition_impl_->post_ResearchDefinition ();
    else
      post_DomainResource ();
  }
...
namespace fhir
{
  // Element validation and dispatch functions for ResearchDefinition_pskel.
  //
  bool ResearchDefinition_pskel::
    ...
    if (vd->func == 0)
    {
      if (vd->state != ~0UL)
      {
        ...
        if (s != ~0UL)
        {
          ...
          vd = vs.data + vs.size++;
          vd->func = &ResearchDefinition_pskel::sequence_0;
          vd->state = s;
          vd->count = 0;
