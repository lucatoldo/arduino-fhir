...
namespace fhir
{
  // EventDefinition_pskel
  //

  void EventDefinition_pskel::
  ...
  EventDefinition_pskel::
  EventDefinition_pskel (EventDefinition_pskel* impl, void*)
  : ::fhir::DomainResource_pskel (impl, 0),
    EventDefinition_impl_ (impl),
    url_parser_ (0),
    identifier_parser_ (0),
    version_parser_ (0),
    name_parser_ (0),
...
namespace fhir
{
  ...
  url ()
  {
    if (this->EventDefinition_impl_)
      this->EventDefinition_impl_->url ();
  }
  ...
  {
    if (this->EventDefinition_impl_)
      this->EventDefinition_impl_->identifier ();
  }
  ...
  {
    if (this->EventDefinition_impl_)
      this->EventDefinition_impl_->version ();
  }
  ...
  {
    if (this->EventDefinition_impl_)
      this->EventDefinition_impl_->name ();
  }
  ...
  {
    if (this->EventDefinition_impl_)
      this->EventDefinition_impl_->title ();
  }
  ...
  {
    if (this->EventDefinition_impl_)
      this->EventDefinition_impl_->subtitle ();
  }
  ...
  {
    if (this->EventDefinition_impl_)
      this->EventDefinition_impl_->status ();
  }
  ...
  {
    if (this->EventDefinition_impl_)
      this->EventDefinition_impl_->experimental ();
  }
  ...
  {
    if (this->EventDefinition_impl_)
      this->EventDefinition_impl_->subjectCodeableConcept ();
  }
  ...
  {
    if (this->EventDefinition_impl_)
      this->EventDefinition_impl_->subjectReference ();
  }
  ...
  {
    if (this->EventDefinition_impl_)
      this->EventDefinition_impl_->date ();
  }
  ...
  {
    if (this->EventDefinition_impl_)
      this->EventDefinition_impl_->publisher ();
  }
  ...
  {
    if (this->EventDefinition_impl_)
      this->EventDefinition_impl_->contact ();
  }
  ...
  {
    if (this->EventDefinition_impl_)
      this->EventDefinition_impl_->description ();
  }
  ...
  {
    if (this->EventDefinition_impl_)
      this->EventDefinition_impl_->useContext ();
  }
  ...
  {
    if (this->EventDefinition_impl_)
      this->EventDefinition_impl_->jurisdiction ();
  }
  ...
  {
    if (this->EventDefinition_impl_)
      this->EventDefinition_impl_->purpose ();
  }
  ...
  {
    if (this->EventDefinition_impl_)
      this->EventDefinition_impl_->usage ();
  }
  ...
  {
    if (this->EventDefinition_impl_)
      this->EventDefinition_impl_->copyright ();
  }
  ...
  {
    if (this->EventDefinition_impl_)
      this->EventDefinition_impl_->approvalDate ();
  }
  ...
  {
    if (this->EventDefinition_impl_)
      this->EventDefinition_impl_->lastReviewDate ();
  }
  ...
  {
    if (this->EventDefinition_impl_)
      this->EventDefinition_impl_->effectivePeriod ();
  }
  ...
  {
    if (this->EventDefinition_impl_)
      this->EventDefinition_impl_->topic ();
  }
  ...
  {
    if (this->EventDefinition_impl_)
      this->EventDefinition_impl_->author ();
  }
  ...
  {
    if (this->EventDefinition_impl_)
      this->EventDefinition_impl_->editor ();
  }
  ...
  {
    if (this->EventDefinition_impl_)
      this->EventDefinition_impl_->reviewer ();
  }
  ...
  {
    if (this->EventDefinition_impl_)
      this->EventDefinition_impl_->endorser ();
  }
  ...
  {
    if (this->EventDefinition_impl_)
      this->EventDefinition_impl_->relatedArtifact ();
  }
  ...
  {
    if (this->EventDefinition_impl_)
      this->EventDefinition_impl_->trigger ();
  }
  ...
  {
    if (this->EventDefinition_impl_)
      this->EventDefinition_impl_->post_EventDefinition ();
    else
      post_DomainResource ();
  }
...
namespace fhir
{
  // Element validation and dispatch functions for EventDefinition_pskel.
  //
  bool EventDefinition_pskel::
    ...
    if (vd->func == 0)
    {
      if (vd->state != ~0UL)
      {
        ...
        if (s != ~0UL)
        {
          ...
          vd = vs.data + vs.size++;
          vd->func = &EventDefinition_pskel::sequence_0;
          vd->state = s;
          vd->count = 0;
